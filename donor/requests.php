...
<option value="A-">A-</option>
 ...
 <tr><td class="lefttd" align="center">Address</td><td><input type="text" name="t11" required="required" pattern="[a-zA-Z _ ,]{5,20}" title="please enter only character  between 5 to 20 for Address" /></td></tr>
 <tr><td>&nbsp;</td></tr>
...
if(isset($_POST["sbmt"])) 
{
	...
	$cn=makeconnection();
		$d=$_POST["year"]."/".$_POST["month"]."/".$_POST["day"];
			$s="insert into requestes(name,gender,age,mobile,bg_name,email,reqdate,detail,quan,Address) values('" . $_POST["t1"] ."','" . $_POST["r1"] . "','" . $_POST["t2"] . "','" . $_POST["t3"] . "','" . $_POST["bl"] . "','" . $_POST["t5"] . "','" . $d .  "','" .  $_POST["t7"]  ."','" .  $_POST["t10"]  ."','" .  $_POST["t11"]  ."')";

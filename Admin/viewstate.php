...
<title>Blood Bank | View State</title>
...
<tr><td style=" padding-left:10px">State No. </td><td style=" padding-left:10px">State Id </td><td style=" padding-left:10px">State Name</td></tr>
<tr><td>
<tr><td>
<?php
...
$s="select * from state";
	...
	while($data=mysqli_fetch_array($result))
	{
				...
				echo "<tr><td style=' padding-left:10px'>$x</td><td style=' padding-left:10px'>$data[0]</td><td style='padding-left:10px'>$data[1]</td></tr>";
                $x++;
		}

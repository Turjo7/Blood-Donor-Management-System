...
<tr><td class="lefttd">Mobile No</td><td><input type="number" name="t3" required="required" pattern="[0-9]{11}" title="please enter only numbers between 10 to 11 for mobile no." /></td></tr>
<!--<tr><td class="lefttd"> Blood Group </td><td><select name="t4" required></td></tr>-->
